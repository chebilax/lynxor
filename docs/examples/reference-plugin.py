#!/usr/bin/env python3
"""Reference implementation of the Lynxor plugin protocol (v1).
...
The --misbehave modes exist only to exercise Lynxor's failure-handling
    ...
    for line in sys.stdin:
        ...
        if msg["type"] == "file":
            ...
            if MISBEHAVE == "timeout":
                time.sleep(30)  # longer than Lynxor's 5s per-file timeout
            if MISBEHAVE == "error":
